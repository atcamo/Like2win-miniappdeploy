...
/**
 * @title Like2Win Daily Raffle Smart Contract
...
contract Like2WinDailyRaffle is ReentrancyGuard, Ownable {
    ...
    function _formatDate(uint256 timestamp) internal pure returns (string memory) {
        // Simple date formatting - in production you might want more sophisticated formatting
        return string(abi.encodePacked("Day-", _toString((timestamp - 1672531200) / 86400))); // Days since 2023-01-01
    }
